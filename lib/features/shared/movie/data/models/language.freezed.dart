...
@JsonKey(name: 'iso_639_1') String get iso6391;@JsonKey(name: 'name') String get name;@JsonKey(name: 'english_name') String? get englishName;
...
@useResult
$Res call({
@JsonKey(name: 'iso_639_1') String iso6391,@JsonKey(name: 'name') String name,@JsonKey(name: 'english_name') String? englishName
});
...
/// Create a copy of SpokenLanguage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? iso6391 = null,Object? name = null,Object? englishName = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'iso_639_1')  String iso6391, @JsonKey(name: 'name')  String name, @JsonKey(name: 'english_name')  String? englishName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SpokenLanguage() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'iso_639_1')  String iso6391, @JsonKey(name: 'name')  String name, @JsonKey(name: 'english_name')  String? englishName)  $default,) {final _that = this;
switch (_that) {
case _SpokenLanguage():
return $default(_that.iso6391,_that.name,_that.englishName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'iso_639_1')  String iso6391, @JsonKey(name: 'name')  String name, @JsonKey(name: 'english_name')  String? englishName)?  $default,) {final _that = this;
switch (_that) {
case _SpokenLanguage() when $default != null:
return $default(_that.iso6391,_that.name,_that.englishName);case _:
  return null;
...
class _SpokenLanguage implements SpokenLanguage {
  const _SpokenLanguage({@JsonKey(name: 'iso_639_1') required this.iso6391, @JsonKey(name: 'name') required this.name, @JsonKey(name: 'english_name') this.englishName});
...
/// Create a copy of SpokenLanguage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? iso6391 = null,Object? name = null,Object? englishName = freezed,}) {
