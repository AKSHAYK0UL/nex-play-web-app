  ...
  Future<ApiResponse<Movie>> getMovieDetails(int id, String lang) async {
    ...
    final _options = _setStreamType<ApiResponse<Movie>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'http://192.168.29.141:8080/api/v1/movie/details',
  ...
  Future<Paged<Movie>> getNowPlaying(String lang, int page) async {
    ...
    final _options = _setStreamType<Paged<Movie>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'http://192.168.29.141:8080/api/v1/movie/now_playing',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<Paged<Movie>> getTrending(String lang, String time, int page) async {
    ...
    final _options = _setStreamType<Paged<Movie>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'http://192.168.29.141:8080/api/v1/movie/trending',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<Paged<Movie>> getUpcoming(String lang, int page) async {
    ...
    final _options = _setStreamType<Paged<Movie>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'http://192.168.29.141:8080/api/v1/movie/upcoming',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<Paged<Movie>> getPopular(String lang, int page) async {
    ...
    final _options = _setStreamType<Paged<Movie>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'http://192.168.29.141:8080/api/v1/movie/popular',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<Paged<Movie>> getTopRated(String lang, int page) async {
    ...
    final _options = _setStreamType<Paged<Movie>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'http://192.168.29.141:8080/api/v1/movie/top_rated',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<Paged<Movie>> getSimilar(int id, String lang, int page) async {
    ...
    final _options = _setStreamType<Paged<Movie>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'http://192.168.29.141:8080/api/v1/movie/similar',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<Paged<Movie>> getRecommendations(int id, String lang, int page) async {
    ...
    final _options = _setStreamType<Paged<Movie>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'http://192.168.29.141:8080/api/v1/movie/recommendations',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
